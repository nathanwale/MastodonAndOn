...
//        let remainingSeconds = totalSeconds.truncatingRemainder(dividingBy: 60)
//        let formattedSeconds = String(format: "%02d.1f", remainingSeconds)
...
// MARK: - previews
#Preview {
    AudioAttachmentView(url: URL(string: "https://freetestdata.com/wp-content/uploads/2021/09/Free_Test_Data_1MB_MP3.mp3")!)
}
